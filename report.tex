...
\verbatiminput{../code/problem1a.py}
\end{framed}
...
\begin{framed}
\fontsize{5.65}{6.78}\selectfont
\verbatiminput{../code/problem1b.py}
\end{framed}
...
\begin{framed}
\fontsize{5.65}{6.78}\selectfont
\verbatiminput{../code/problem1c.py}
\end{framed}
...
\begin{framed}
\fontsize{5.65}{6.78}\selectfont
\verbatiminput{../code/problem1d.py}
\end{framed}
...
\begin{framed}
\fontsize{5.65}{6.78}\selectfont
\verbatiminput{../code/problem1e.py}
\end{framed}
...
\begin{framed}
\fontsize{5.65}{6.78}\selectfont
\verbatiminput{../code/problem1f.py}
\end{framed}
...
\begin{framed}
\fontsize{5.65}{6.78}\selectfont
\verbatiminput{../code/problem1g.py}
\end{framed}
...
\begin{framed}
\fontsize{5.65}{6.78}\selectfont
\verbatiminput{../code/problem1h.py}
\end{framed}
...
\begin{framed}
\fontsize{5.65}{6.78}\selectfont
\verbatiminput{../code/problem1i.py}
\end{framed}
