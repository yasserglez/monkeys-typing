...
\hline
1  & 7.17\% & 13.23\% & 14 & 4.90\% & 9.73\% \\
3  & 8.30\% & 14.13\% & 15 & 8.23\% & 14.25\% \\
4  & 7.23\% & 12.85\% & 19 & 12.7\% & 19.88\% \\
5  & 8.49\% & 13.84\% & 22 & 6.66\% & 11.83\% \\
6  & 7.82\% & 13.69\% & 23 & 6.58\% & 12.06\% \\
10 & 8.58\% & 14.65\% & 25 & 7.70\% & 15.10\% \\
11 & 6.64\% & 11.98\% & 27 & 9.78\% & 16.57\% \\
12 & 9.79\% & 17.58\% &    &    & \\
\hline
\end{tabular}
\end{center}
...
...three books of small, medium and large size were selected among the 
books listed in Table~\ref{tab:data} (numbered 14, 4, and 5 respectively).
...
\begin{table}
\caption{\hspace{2em}Most probable digraph (starting with `t') and \newline 
trigraph (starting with `th') paths.\label{tab:problem1f}}
\vspace{-10pt}
\begin{center}
\begin{tabular}{cll}
\hline 
