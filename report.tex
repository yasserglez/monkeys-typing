...
The normalization of the frequency table by a fraction of the maximum frequency zeroes entries with low frequencies that produce ``noise'' on the generated output.
